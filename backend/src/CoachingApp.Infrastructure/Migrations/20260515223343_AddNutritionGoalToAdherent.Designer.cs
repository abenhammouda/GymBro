...
namespace CoachingApp.Infrastructure.Migrations
{
    ...
    [Migration("20260515223343_AddNutritionGoalToAdherent")]
    partial class AddNutritionGoalToAdherent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.FoodAliasCache", b =>
                {
                    b.Property<int>("FoodAliasCacheId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FoodAliasCacheId"));
                    ...
                    b.ToTable("FoodAliasCaches");
                });

            modelBuilder.Entity("CoachingApp.Core.Entities.IntakePhoto", b =>
                {
                    b.Property<int>("IntakePhotoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IntakePhotoId"));
                    ...
                    b.HasKey("IntakePhotoId");

                    b.HasIndex("AdherentId");

                    b.ToTable("IntakePhotos");
                });

            modelBuilder.Entity("CoachingApp.Core.Entities.MacroPlan", b =>
                {
                    b.Property<int>("MacroPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MacroPlanId"));
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.MealIngredient", b =>
                {
                    ...
                    b.Property<bool>("MacroCalculationFailed")
                        .HasColumnType("bit");

                    b.Property<int?>("MacroSource")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.NutritionFood", b =>
                {
                    b.Property<int>("NutritionFoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NutritionFoodId"));
                    ...
                    b.Property<string>("CanonicalNameFr")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.SupplementGroup", b =>
                {
                    b.Property<int>("SupplementGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SupplementGroupId"));
                    ...
                    b.Property<int>("SupplementSetId")
                        .HasColumnType("int");

                    b.HasKey("SupplementGroupId");

                    b.HasIndex("SupplementSetId");

                    b.ToTable("SupplementGroups");
                });

            modelBuilder.Entity("CoachingApp.Core.Entities.SupplementSet", b =>
                {
                    b.Property<int>("SupplementSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SupplementSetId"));
                    ...
                    b.HasKey("SupplementSetId");

                    b.HasIndex("CoachId", "Timing", "Index")
                        .IsUnique();

                    b.ToTable("SupplementSets");
                });

            modelBuilder.Entity("CoachingApp.Core.Entities.SupplementSetItem", b =>
                {
                    b.Property<int>("SupplementSetItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SupplementSetItemId"));
                    ...
                    b.HasKey("SupplementSetItemId");

                    b.HasIndex("SupplementGroupId");

                    b.ToTable("SupplementSetItems");
                });
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.FoodAliasCache", b =>
                {
                    b.HasOne("CoachingApp.Core.Entities.NutritionFood", "NutritionFood")
                        .WithMany()
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.SupplementGroup", b =>
                {
                    b.HasOne("CoachingApp.Core.Entities.SupplementSet", "Set")
                        .WithMany("Groups")
                        .HasForeignKey("SupplementSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoachingApp.Core.Entities.SupplementSetItem", b =>
                {
                    b.HasOne("CoachingApp.Core.Entities.SupplementGroup", "Group")
                        .WithMany("Items")
